...
3. After solving a meaningful problem, use `exp-bar` to record:
   - `Problem`
   - `Plan`
   - `Attempts`
   - `Solution`
...
- New knowledge should normally enter through `exp-bar` first, then be promoted later only if it proves reusable.
